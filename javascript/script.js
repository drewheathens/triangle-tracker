...
else if (number1+number2<=number3 || number2+number3<=number1) alert(" triangle cannot be formed using those values!");

else if (number1!==number2 && number2!==number3 &&  number3!==number1) alert("scalene!")
